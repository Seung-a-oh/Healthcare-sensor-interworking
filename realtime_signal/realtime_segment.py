...
class Scope(object):
    ...
    def __init__(self,
                 ...
                 xmax=5,ymax =3.5,
                 xstart=0, ystart=0,
                 title='Real Time PPG Signal',xlabel='Time(sec)',ylabel='PPG(V)'):
...
class Scope1(object):
    ...
    def __init__(self,
                 ...
                 xmax=5,ymax =3.5,
                 xstart=0, ystart=0,
                 title='Real Time BEAT Signal',xlabel='Time(sec)',ylabel='Beat'):
...
fig = plt.figure() 
fig.subplots_adjust(hspace=0.5) #subplot 사이 간격 조절
...
ani_ppg =animation.FuncAnimation(fig, scope_ppg.update,interval=1,blit=1)
ani_beat = animation.FuncAnimation(fig, scope_beat.update,interval=1,blit=1)
plt.show()
