...
class Scope(object):
    ...
    def __init__(self,
                 ...
                 xmax=5,ymax =3.5,
                 xstart=0, ystart=0,
                 title='Real Time PPG Signal',xlabel='Time(sec)',ylabel='ECG(mV)'):
...
ani1 = animation.FuncAnimation(fig, scope_ppg.update, interval=0.02,blit=1), animation.FuncAnimation(fig, scope_beat.update,interval=0.02, blit=1)

# writer = animation.FFMpegWriter(
#    fps=15, metadata=dict(artist='Me'), bitrate=1800)

# ani1.save("movie.mp4", writer=writer)
